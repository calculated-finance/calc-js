...
import { CreditAccounts } from "../liquidate/CreditAccounts";
...
export function Liquidate() {
  ...
  return (
    <TranslationProvider namespace="liquidate">
      <ProductSeoHelmet seo={getStaticProductSeo("/liquidate", locale)} />
      <LiquidateContent />
    </TranslationProvider>
  );
}

function LiquidateContent() {
