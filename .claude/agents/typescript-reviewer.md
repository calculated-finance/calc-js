...
For the repo-specific domain checklist (decimal math, signer safety, Relay fragment correctness, i18n, immutability, cross-package blast radius), defer to the `review-focus-areas` skill. That skill is the canonical checklist and is referenced by every other review path in this repo.
