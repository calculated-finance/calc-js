/**
 * @generated SignedSource<<461c79e3dba5bc1d3a1e4535b2e9492a>>
...
export type OracleSubmitFragment$data = {
  ...
  readonly " $fragmentType": "OracleSubmitFragment";
};
export type OracleSubmitFragment$key = {
  readonly " $data"?: OracleSubmitFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"OracleSubmitFragment">;
};
...
(node as any).hash = "1042ad55342ba4c34ef0707e79918b34";
