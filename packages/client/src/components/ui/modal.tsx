...
function ModalTrigger({ children, dialogProps, drawerProps, ...props }: ModalTriggerProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
...
function ModalContent({ children, dialogProps, drawerProps, ...props }: ModalContentProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
...
function ModalHeader({ children, dialogProps, drawerProps, ...props }: ModalHeaderProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
...
function ModalFooter({ children, dialogProps, drawerProps, ...props }: ModalFooterProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
...
function ModalTitle({ children, dialogProps, drawerProps, ...props }: ModalTitleProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
...
function ModalDescription({ children, dialogProps, drawerProps, ...props }: ModalDescriptionProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
...
function ModalClose({ children, dialogProps, drawerProps, ...props }: ModalCloseProps) {
  const isDesktop = useMediaQuery("(min-width: 768px)");
